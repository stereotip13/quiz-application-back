...
export class QuestionsService {
  constructor(@InjectModel(Questions) private readonly questionRepository: typeof Questions){}
  ...
  async getQuestionByValue(id:number, dto: CreateQuestionDTO): Promise<CreateQuestionDTO>{
    try {
